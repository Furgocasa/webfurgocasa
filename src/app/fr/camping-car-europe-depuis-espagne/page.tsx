...
export default async function LocaleMotorhomeEuropaLatamPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      {/* Section: Réduction Spéciale - Avec lien blog */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg mb-4 text-orange-100">
              Si vous venez de <strong>Belgique, Suisse, Canada, Afrique ou tout autre pays</strong>, 
              {' '}vous bénéficiez d'une <strong>réduction de -15%</strong> sur les locations de minimum 2 semaines.
            </p>
            
            {/* Exemples d'économies */}
            <div className="grid md:grid-cols-2 gap-4 mb-8 max-w-2xl mx-auto">
              <div className="bg-white/20 backdrop-blur-sm p-4 rounded-xl">
                <p className="font-bold text-xl mb-1">21 jours (3 semaines)</p>
                <p className="text-orange-100">Économisez jusqu'à <strong className="text-white text-2xl">285€</strong></p>
              </div>
              <div className="bg-white/20 backdrop-blur-sm p-4 rounded-xl">
                <p className="font-bold text-xl mb-1">14 jours (2 semaines)</p>
                <p className="text-orange-100">Économisez jusqu'à <strong className="text-white text-2xl">210€</strong></p>
              </div>
            </div>
            
            {/* Pays */}
            <div className="flex flex-wrap justify-center gap-3 mb-8">
              {['🇧🇪 Belgique', '🇨🇭 Suisse', '🇨🇦 Canada', '🇫🇷 France', '🇱🇺 Luxembourg', '🇲🇦 Maroc', '🇹🇳 Tunisie', '🇸🇳 Sénégal'].map((pays) => (
                <span key={pays} className="bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium">
                  {pays}
                </span>
              ))}
            </div>
            
            {/* Boutons - Blog d'abord, WhatsApp ensuite */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="https://wa.me/34673414053?text=Bonjour!%20Je%20viens%20de%20[VOTRE%20PAYS]%20et%20je%20voudrais%20demander%20la%20réduction%20de%20-15%25"
                target="_blank"
            ...
            <p className="text-sm text-orange-100 mt-6 max-w-2xl mx-auto">
              * Valable pour locations de minimum 2 semaines en Basse et Moyenne Saison (septembre-juin). 
              Vous devez prouver votre voyage international avec des billets d'avion.
            </p>
          </div>
        </div>
      </section>
