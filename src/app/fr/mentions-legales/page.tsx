          ...
          <div className="container mx-auto px-4">
            <div className="bg-white rounded-xl shadow-sm p-8 max-w-4xl mx-auto prose prose-gray max-w-none">
              ...
              <ul>
                ...
                <li><strong>Siège social :</strong> {COMPANY.address.street} - {COMPANY.address.postalCode} {COMPANY.address.locality}</li>
                <li><strong>E-mail :</strong> {COMPANY.email}</li>
                <li><strong>Téléphone :</strong> {COMPANY.phoneDisplayFull}</li>
                <li><strong>Données fiscales et d'immatriculation :</strong> communiquées au client dans la documentation contractuelle et sur demande formelle par e-mail.</li>
              </ul>
