...
const MAPA_AREAS_METADATA: Metadata = {
  title: "Carte des Aires Camping-Cars",
  description: "Trouvez les meilleures aires de service et de stationnement pour camping-cars et vans en Espagne. Carte interactive avec services, avis et photos.",
};
        ...
        <section className="py-16 bg-gradient-to-r from-furgocasa-orange to-orange-500">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href={`/${locale}/contacto`} className="inline-flex items-center justify-center gap-2 bg-white/20 text-white font-semibold py-4 px-8 rounded-xl hover:bg-white/30 transition-colors border border-white/40">
                Sugerir un área
              </a>
            </div>
          </div>
