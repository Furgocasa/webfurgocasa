...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generateMultilingualMetadata('/autocaravanas', locale, {
    ...
    en: {
      ...
      keywords: "motorhomes, motorhome types, motorhome licence, motorhome regulations Spain",
    },
    fr: {
...
export default async function CampingCarsPage() {
  ...
  try {
    ...
    console.error('[camping-cars-espagne] Error loading data:', err);
  }
