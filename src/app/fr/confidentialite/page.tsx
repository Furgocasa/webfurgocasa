...
const PRIVACIDAD_METADATA: Metadata = {
  title: "Politique de Confidentialité - Furgocasa | Protection des Données",
  description: "Politique de confidentialité et protection des données de Furgocasa S.L. Informations sur le traitement de vos données personnelles selon le RGPD.",
  keywords: "politique confidentialité furgocasa, protection données, rgpd, vie privée",
  robots: {
    index: false,
    follow: false,
    nocache: true,
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="bg-white rounded-xl shadow-sm p-8 max-w-4xl mx-auto prose prose-gray max-w-none">
              ...
              <ul>
                <li><strong>Identité :</strong> {COMPANY.legalName}</li>
                ...
                <li><strong>Téléphone :</strong> {COMPANY.phoneDisplayFull}</li>
              </ul>
              ...
              <p>Pour exercer ces droits, vous pouvez nous contacter à {COMPANY.email} en joignant une copie de votre pièce d'identité.</p>
