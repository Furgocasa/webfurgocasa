  ...
  return (
    <div className="text-center">
      ...
      <div className="space-y-3">
        {bookingId && (
          <LocalizedLink href={`/reserver/${bookingId}`}
...
function PagoExitoContent() {
  ...
  useEffect(() => {
    ...
    if (isFirstPayment) {
      ...
      console.log("[GTM] purchase envoyé (premier paiement):", payment.order_number);
    } else {
      sendGTMEvent({
      ...
      console.log("[GTM] additional_payment_received envoyé:", payment.order_number);
    }
