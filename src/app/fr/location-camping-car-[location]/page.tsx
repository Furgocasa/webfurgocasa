...
// Locale: FR (Français) | Kind: rent (Location)
// ============================================================================
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const title = translated.meta_title || location.meta_title || `${t("Location de Camping-cars à")} ${translated.name || location.name}`;
  const description = translated.meta_description || location.meta_description || 
    `${t("Louez votre camping-car à")} ${translated.name || location.name}. ${t("Flotte premium avec kilométrage illimité")}.`;
  ...
  return (
    <>
      ...
      <section className="relative h-[60vh] min-h-[500px] flex items-center justify-center">
        ...
        <Image
          src={heroImageUrl}
          alt={location.h1_title || `${t("Location de Camping-cars à")} ${location.name}`}
          fill
          priority
        ...
        <div className="relative z-20 container mx-auto px-4 text-center text-white">
          <h1 className="text-4xl lg:text-6xl font-heading font-bold mb-6 drop-shadow-lg">
            {location.h1_title || `${t("Location de Camping-cars à")} ${location.name}`}
          </h1>
          {location.intro_text && (
            ...
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-heading font-bold text-gray-900 mb-2">
                    {t("Point de retrait le plus proche")}
                  </h2>
              ...
              <div className="flex items-center gap-2 text-green-700 bg-green-50 px-4 py-3 rounded-lg">
                ...
                <span className="font-medium">
                  {t("Prise en charge et restitution disponibles à cet emplacement")}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-heading font-bold text-gray-900 mb-4">
                {t("Nos camping-cars disponibles")}
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                {t("Flotte premium avec kilométrage illimité")}
              </p>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-heading font-bold text-gray-900 mb-4">
              {t("Pourquoi louer avec Furgocasa?")}
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              { icon: Shield, title: t("Assurance tous risques"), desc: t("Voyagez en toute tranquillité") },
              { icon: CheckCircle, title: t("Km illimités"), desc: t("Sans limites de distance") },
              { icon: Calendar, title: t("Flexibilité"), desc: t("Retrait où vous préférez") },
              { icon: Phone, title: t("Assistance 24/7"), desc: t("Toujours disponibles") },
            ].map((service, index) => (
      ...
      <section className="py-16 bg-furgocasa-blue text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl lg:text-4xl font-heading font-bold mb-6">
            {t("Prêt pour votre aventure?")}
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90">
            {t("Réservez votre camping-car maintenant et commencez à planifier votre prochain voyage")}
          </p>
          <LocalizedLink
            href="/vehicules"
          ...
          >
            {t("Voir les véhicules disponibles")}
            <ArrowRight className="h-5 w-5" />
          </LocalizedLink>
        </div>
      </section>
