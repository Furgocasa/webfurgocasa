...
export default async function LocationPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-6xl mx-auto space-y-3">
            {/* H1 dynamique depuis la BD (h1_title) ou fallback */}
            <h1 
            ...
            {/* Intro text dynamique depuis la BD ou fallback */}
            <p 
            ...
            >
              {location.intro_text || "Les meilleurs camping-cars grand volume en location"}
            </p>
          </div>
      ...
      {/* PRINCIPALES DESTINATIONS - Identique à la production */}
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 lg:mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-3xl lg:text-5xl font-heading font-bold text-gray-900">
                Principales destinations à visiter en Camping-car
              </h2>
            </div>
            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
              Découvrez les meilleures destinations pour votre prochaine aventure en camping-car
            </p>
          </div>
