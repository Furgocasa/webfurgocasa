...
export default async function LocationPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <LocalBusinessJsonLd location={location as any} locale="fr" />
      ...
      <section className="relative h-screen lg:h-[calc(100vh-120px)] min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 w-full text-center">
          <div className="w-full px-4 lg:px-[25%] space-y-3">
            ...
            >
              Dreamer, Knaus, Weinsberg. Espagne et Europe.
            </p>
          </div>
      ...
      <section className="py-12 lg:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
              {nearbyLocations.length > 0
                ? t("Louez votre camping-car et explorez ces localités proches depuis") + ` ${location.name}`
                : t("Descubre los mejores destinos para tu próxima aventura en autocaravana")}
            </p>
          </div>
          <DestinationsGrid
            title={nearbyLocations.length > 0 ? t("Destinations proches") : undefined}
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      {article.published_at && (
                        <time dateTime={article.published_at}>
                          {new Date(article.published_at).toLocaleDateString('fr-FR', { timeZone: 'Europe/Madrid' })}
                        </time>
                      )}
      ...
      {/* CONTENU TOURISTIQUE - Entre blog et pourquoi Furgocasa */}
