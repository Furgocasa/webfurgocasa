                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredAndSortedVehicles.map((vehicle) => (
                    ...
                    >
                      ...
                      <div className="p-5">
                        <LocalizedLink href={`/ventas/${vehicle.slug}`} className="block mb-3">
                          <h3 className="text-xl sm:text-2xl font-heading font-bold text-gray-900 group-hover:text-furgocasa-orange transition-colors leading-tight mb-2">
                            {vehicle.name}
                          </h3>
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <span className="inline-flex items-center gap-1 rounded-lg bg-furgocasa-blue/10 px-2.5 py-1 text-xs font-bold text-furgocasa-blue">
                              {vehicle.year}
                            </span>
                            <span className="inline-flex items-center gap-1 rounded-lg bg-furgocasa-orange/10 border border-furgocasa-orange/30 px-2.5 py-1 text-xs font-bold text-furgocasa-orange">
