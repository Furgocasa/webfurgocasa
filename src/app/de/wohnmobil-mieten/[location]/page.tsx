      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-6xl mx-auto space-y-3">
            {/* H1 dynamisch aus der DB (h1_title) oder Fallback */}
            <h1 
            ...
            >
              {location.h1_title || `Wohnmobil Mieten ${location.name}`}
            </h1>
            ...
            {/* Intro text dynamisch aus der DB oder Fallback */}
            <p 
            ...
            >
              {location.intro_text || "Die besten großvolumigen Wohnmobile zur Miete"}
            </p>
          </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-gray-100">
                ...
                <div className="mt-6 flex items-center gap-2 text-green-700 bg-green-50 px-6 py-4 rounded-xl">
                  ...
                  <span className="font-medium text-lg">
                    Lieferung und Abholung in {location.name} verfügbar
                  </span>
                </div>
              </div>
            </div>
