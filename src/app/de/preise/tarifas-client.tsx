        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="max-w-4xl mx-auto bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-bold text-lg mb-3 flex items-center gap-2"><Clock className="h-5 w-5 text-furgocasa-orange" />{t("Información general")}</h4>
              ...
              <div>
                <h4 className="font-bold text-lg mb-3 flex items-center gap-2"><CreditCard className="h-5 w-5 text-furgocasa-orange" />{t("Método de pago")}</h4>
                <p className="text-sm text-blue-100">{t("El método de pago aceptado será el pago con tarjeta de débito o crédito a través de nuestra pasarela de pago segura Redsys.")}</p>
              </div>
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg">{t("Consulta nuestro calendario para planificar tu viaje")}</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-blue-600 text-white rounded-3xl p-10 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h4 className="font-heading font-bold text-2xl mb-4 flex items-center gap-3"><Shield className="h-8 w-8 text-blue-300" />{t("Seguro de Cancelación")}</h4>
                  <p className="text-blue-100 text-lg leading-relaxed mb-6">{t("Por 5€/día (contratado al reservar), se limita el coste de cancelación en el periodo de 59 a 16 días a dicho importe.")}</p>
                </div>
              </div>

              <div className="bg-white rounded-3xl p-10 shadow-lg border border-gray-100">
                <h3 className="font-heading font-bold text-xl text-gray-900 mb-4 flex items-center gap-2"><FileText className="h-6 w-6 text-furgocasa-orange" />{t("Derecho de desistimiento")}</h3>
                <p className="text-gray-600 mb-8 leading-relaxed">{t("El cliente dispone de 14 días naturales del derecho a desistir del contrato de alquiler sin necesidad de justificación y sin penalización alguna.")}</p>
              </div>
            </div>
          </div>
        </div>
