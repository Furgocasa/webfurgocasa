  ...
  return (
    <main className="min-h-screen bg-gray-50 font-amiko">
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 text-lg">{t("Tarifas orientativas por día según temporada")}</p>
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">{t("Pasos del alquiler")}</h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">{t("Así es el proceso de reserva de tu camper paso a paso")}</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto">
            {[
              ...
              <div key={item.paso} className="bg-white rounded-xl p-5 border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                <div className="w-10 h-10 bg-furgocasa-orange text-white rounded-full flex items-center justify-center font-bold text-lg mb-3">{item.paso}</div>
      ...
      {/* Temporadas - Calendarios */}
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">{t("Temporadas de alquiler")}</h2>
            <p className="text-gray-600 text-lg mb-6">{t("Consulta nuestro calendario para planificar tu viaje")}</p>
            
            {/* Leyenda de colores */}
            <div className="flex flex-wrap justify-center gap-6 mt-8">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-white border-2 border-gray-300 rounded"></div>
                <span className="text-sm font-medium text-gray-700">Nebensaison</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-orange-200 border-2 border-orange-300 rounded"></div>
                <span className="text-sm font-medium text-gray-700">Mittlere Saison</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-red-200 border-2 border-red-300 rounded"></div>
                <span className="text-sm font-medium text-gray-700">Hochsaison</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-12 max-w-7xl mx-auto">
            <div className="bg-gray-50 rounded-3xl p-6 md:p-8 shadow-inner">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-heading font-bold text-furgocasa-blue bg-white py-3 px-6 rounded-xl shadow-sm inline-block">{t("Calendario")} {currentYear}</h3>
              </div>
            ...
            <div className="bg-gray-50 rounded-3xl p-6 md:p-8 shadow-inner">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-heading font-bold text-furgocasa-blue bg-white py-3 px-6 rounded-xl shadow-sm inline-block">{t("Calendario")} {nextYear}</h3>
              </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">{t("Requisitos del conductor")}</h2>
            <p className="text-gray-600 text-lg">{t("Todo lo que necesitas para alquilar una camper con nosotros")}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-12">
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center border-b-4 border-furgocasa-blue">
              ...
              <h3 className="font-heading font-bold text-xl text-gray-900 mb-3">{t("Edad mínima")}</h3>
              <p className="text-gray-600 mb-4 font-medium">{t("El conductor principal y cada conductor adicional deben tener un mínimo de 25 años de edad.")}</p>
              <span className="inline-block bg-gray-100 text-gray-500 text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wide">{t("Máximo 2 conductores")}</span>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center border-b-4 border-furgocasa-orange">
              ...
              <h3 className="font-heading font-bold text-xl text-gray-900 mb-3">{t("Permiso de conducción")}</h3>
              <p className="text-gray-600 mb-4 font-medium">{t("Carnet de conducir tipo B en vigor, con una antigüedad mínima de 2 años.")}</p>
              <span className="inline-block bg-gray-100 text-gray-500 text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wide">{t("Permiso internacional si no UE")}</span>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-shadow text-center border-b-4 border-green-500">
              ...
              <h3 className="font-heading font-bold text-xl text-gray-900 mb-3">{t("Documentación")}</h3>
              <p className="text-gray-600 mb-4 font-medium">{t("Debes enviar copia del DNI/Pasaporte y del carnet de conducir antes del inicio del alquiler.")}</p>
              <a href="mailto:reservas@furgocasa.com" className="inline-block text-furgocasa-blue font-bold text-sm hover:underline">reservas@furgocasa.com</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-4">{t("Duración del alquiler")}</h2>
            <p className="text-gray-600 text-lg">{t("Mínimos establecidos según temporada")}</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            <div className="bg-white border-2 border-blue-100 rounded-3xl p-8 text-center hover:border-blue-500 transition-colors group">
              <h3 className="font-heading font-bold text-lg text-gray-500 mb-4 uppercase tracking-wider group-hover:text-blue-600 transition-colors">{t("Temp. Baja y Media")}</h3>
            ...
            <div className="bg-white border-2 border-orange-100 rounded-3xl p-8 text-center hover:border-orange-500 transition-colors group">
              <h3 className="font-heading font-bold text-lg text-gray-500 mb-4 uppercase tracking-wider group-hover:text-orange-600 transition-colors">{t("Temporada Alta")}</h3>
            ...
            <div className="bg-white border-2 border-green-100 rounded-3xl p-8 text-center hover:border-green-500 transition-colors group">
              <h3 className="font-heading font-bold text-lg text-gray-500 mb-4 uppercase tracking-wider group-hover:text-green-600 transition-colors">{t("Duración máxima")}</h3>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-center text-gray-900 mb-16">{t("Política de cancelación")}</h2>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-blue-600 text-white rounded-3xl p-8 relative overflow-hidden">
                <div className="absolute top-0 right-0 opacity-10 transform translate-x-1/3 -translate-y-1/3"><Shield className="w-64 h-64" /></div>
                <div className="relative z-10">
                  <h4 className="font-heading font-bold text-xl mb-3 flex items-center gap-3"><Shield className="h-6 w-6 text-blue-300" />{t("Seguro de Cancelación")}</h4>
                  <p className="text-blue-100 text-base leading-relaxed mb-4">{t("Por 5€/día (contratado al reservar), se limita el coste de cancelación en el periodo de 59 a 16 días a dicho importe.")}</p>
                  <p className="text-xs text-blue-300 font-medium uppercase tracking-wide">{t("* No aplica si restan menos de 16 días para el alquiler")}</p>
                </div>
              </div>

              {/* Widerrufsrecht */}
              <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100">
                <h3 className="font-heading font-bold text-xl text-gray-900 mb-3 flex items-center gap-2"><FileText className="h-6 w-6 text-furgocasa-orange" />{t("Derecho de desistimiento")}</h3>
                <p className="text-gray-600 mb-6 leading-relaxed text-sm">{t("El cliente dispone de 14 días naturales del derecho a desistir del contrato de alquiler sin necesidad de justificación y sin penalización alguna.")}</p>
            ...
            {/* Rückerstattung per Überweisung */}
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row gap-12 items-center mb-12">
                <div className="text-center md:text-left">
                  <h2 className="text-3xl md:text-5xl font-heading font-bold mb-4">{t("Fianza")}</h2>
                  <p className="text-gray-400 max-w-md">{t("Garantía del fiel cumplimiento del contrato mediante transferencia bancaria.")}</p>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <ul className="space-y-4">
                  <li className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center"><CreditCard className="h-4 w-4" /></div><span>{t("Pago mediante transferencia bancaria")}</span></li>
                  <li className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center"><Clock className="h-4 w-4" /></div><span>{t("Máximo 72 horas antes del inicio")}</span></li>
                </ul>
                <ul className="space-y-4">
                  <li className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center"><User className="h-4 w-4" /></div><span>{t("El titular debe coincidir con el arrendatario")}</span></li>
                  <li className="flex items-center gap-3"><div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center"><RefreshCw className="h-4 w-4" /></div><span>{t("Devolución en 10 días laborables")}</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-3xl p-10 shadow-lg border-l-8 border-red-500">
                <h3 className="font-bold text-red-600 text-lg mb-4 flex items-center gap-2"><Clock className="h-5 w-5" />{t("Penalizaciones por retraso")}</h3>
      ...
      <section className="py-24 bg-gradient-to-br from-furgocasa-blue to-furgocasa-blue-dark text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-5xl font-heading font-bold text-white mb-6">{t("¿Listo para tu aventura?")}</h2>
          <p className="text-blue-200 mb-10 max-w-2xl mx-auto text-lg">{t("Para cualquier aclaración en relación a lo dispuesto en esta sección, no dude en contactar con nosotros.")}</p>
          <div className="flex flex-wrap justify-center gap-6">
            <LocalizedLink href="/reservar" className="bg-furgocasa-orange text-white font-bold py-4 px-12 rounded-xl hover:bg-furgocasa-orange-dark transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 text-lg">{t("Reservar ahora")}</LocalizedLink>
            <LocalizedLink href="/contacto" className="bg-white/10 backdrop-blur-md text-white border border-white/20 font-bold py-4 px-12 rounded-xl hover:bg-white/20 transition-all text-lg">{t("Contactar")}</LocalizedLink>
          </div>
        </div>
      </section>
    </main>
