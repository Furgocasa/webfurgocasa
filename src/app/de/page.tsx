...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: `${t("Las Mejores Campers en Alquiler")} - ${t("Alquiler en España")} | Furgocasa`,
      description: `${t("Furgocasa: flota premium desde 95€/día con kilómetros ilimitados")}. Dreamer, Knaus, Weinsberg. Spanien und Europa.`,
      type: "website",
      ...
      <section className="relative h-screen md:h-[calc(100vh-120px)] min-h-[600px] flex items-center justify-center">
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <Image
            ...
            alt="Furgocasa - Wohnmobil- und Campervermietung"
            fill
            priority
            sizes="100vw"
