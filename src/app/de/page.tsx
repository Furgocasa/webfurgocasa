        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              <strong>Was ist Furgocasa?</strong> Furgocasa ist ein Wohnmobilvermieter mit Sitz in Murcia, Spanien. Wir bieten eine Premium-Flotte von Dreamer, Knaus und Weinsberg mit unbegrenzten Kilometern in Spanien ab {COMPANY.rentalPolicy.dailyRateFrom.lowSeason}€/Tag je nach Saison. Abholung und Ruckgabe: {COMPANY.rentalPolicy.pickupLocationsLabel}. Kaution: {COMPANY.depositAmount.toLocaleString("de-DE")}€. Telefon: {COMPANY.phoneDisplay}.
            </p>
          </div>
        </div>
      </section>
