...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `${t("Home meta desc campers gran volumen")} Tel. +34 868 36 41 61.`,
    keywords: "wohnmobil mieten, camper mieten, wohnmobilvermietung, campervan mieten, großraumwohnmobil, premium camper, wohnmobil vermietung, furgocasa",
...
export default async function LocaleHomePage() {
  const locale: Locale = 'de'; // Locale fijo para español
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                  <strong className="text-furgocasa-blue">Was ist Furgocasa?</strong> Furgocasa ist ein Wohnmobilvermieter mit Sitz in Murcia, Spanien. Wir bieten eine Premium-Flotte von Dreamer, Knaus und Weinsberg mit unbegrenzten Kilometern in Spanien ab {COMPANY.rentalPolicy.dailyRateFrom.lowSeason}€/Tag je nach Saison. Abholung und Ruckgabe: {COMPANY.rentalPolicy.pickupLocationsLabel}. Kaution: {COMPANY.depositAmount.toLocaleString("de-DE")}€. Telefon: {COMPANY.phoneDisplay}.
                </p>
