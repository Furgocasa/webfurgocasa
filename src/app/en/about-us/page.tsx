...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: "Furgocasa is a family-run motorhome and campervan rental company based in Murcia since 2018, with more than 1,000 trips managed.",
    ...
    openGraph: {
      ...
      title: "About Us - Discover Furgocasa",
      description: "Learn about Furgocasa, a family-run campervan and motorhome rental company in Murcia since 2018.",
      type: "website",
    ...
    twitter: {
      ...
      title: "About Us - Discover Furgocasa",
      description: "Family-run campervan rental company in Murcia since 2018.",
    },
    alternates,
    robots: {
      index: true,
