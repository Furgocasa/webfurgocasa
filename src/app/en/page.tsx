...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords: "camper van rental, motorhome rental, campervan hire, motorhome hire, large campervan rental, premium campervan, rv rental, furgocasa",
...
export default async function LocaleHomePage() {
  const locale: Locale = 'en'; // Locale fijo para español
  ...
  return (
    <>
      ...
      {/* Sección: Servicios destacados - estética corporativa (border-t-4 alternando) */}
      <section className="py-12 lg:py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 lg:mb-16">
            <h2 className="text-3xl lg:text-5xl font-heading font-black text-furgocasa-blue uppercase tracking-wide mb-4">
