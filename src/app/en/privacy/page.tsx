...
const PRIVACIDAD_METADATA: Metadata = {
  title: "Privacy Policy - Furgocasa | Data Protection & RGPD",
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="bg-white rounded-xl shadow-sm p-8 max-w-4xl mx-auto prose prose-gray max-w-none">
              ...
              <ul>
                <li><strong>Identity:</strong> {COMPANY.legalName}</li>
                <li><strong>Address:</strong> {COMPANY.address.street} - {COMPANY.address.postalCode} {COMPANY.address.locality}</li>
              ...
              <p>To exercise these rights, you can contact us at {COMPANY.email} and attach a copy of your identity document.</p>
