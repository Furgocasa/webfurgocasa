...
export default async function LocationPage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-6xl mx-auto space-y-3">
            {/* H1 dynamic from DB (h1_title) or fallback */}
            <h1 
            ...
            >
              {location.h1_title || `Camper Rental ${location.name}`}
            </h1>
            ...
            {/* Intro text dynamic from DB or fallback */}
            <p 
            ...
            >
              {location.intro_text || "The best high-volume camper vans for rent"}
            </p>
          </div>
      ...
      {/* MAIN DESTINATIONS - Identical to production */}
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 lg:mb-16">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h2 className="text-3xl lg:text-5xl font-heading font-bold text-gray-900">
                Main destinations to visit by Campervan
              </h2>
            </div>
            <p className="text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto">
              Discover the best destinations for your next motorhome adventure
            </p>
          </div>
