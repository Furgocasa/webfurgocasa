...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description: `${t("Home meta desc campers gran volumen")} ${t("Furgocasa: alquiler de autocaravanas y campers en España desde 95€/día.")} Teléfono 868 36 41 61.`,
      ...
      <section className="relative pt-24 pb-10 lg:pt-0 lg:pb-0 min-h-[640px] lg:h-[calc(100vh-120px)] lg:min-h-[600px] flex items-start lg:items-center justify-center">
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <Image
            ...
            alt="Furgocasa - Alquiler de campers gran volumen en España"
            fill
            priority
            sizes="100vw"
