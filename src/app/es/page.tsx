...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: `${t("Furgocasa: flota premium desde 95€/día con kilómetros ilimitados")}. Dreamer, Knaus, Weinsberg. España y Europa.`,
      type: "website",
      ...
      <section className="relative h-screen lg:h-[calc(100vh-120px)] min-h-[600px] flex items-center justify-center">
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <Image
            ...
            alt="Furgocasa - Alquiler de autocaravanas camper"
            fill
            priority
            sizes="100vw"
