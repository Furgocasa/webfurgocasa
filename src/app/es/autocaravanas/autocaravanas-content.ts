...
const CONTENT_ES: AutocaravanasContent = {
  ...
  benefits: [
    ...
    { title: "Equipamiento completo de viaje", desc: "Cocina completa, menaje, kit de camping y extras opcionales para personalizar tu reserva." },
...
const CONTENT_EN: AutocaravanasContent = {
  ...
  benefits: [
    ...
    { title: "Full travel equipment", desc: "Full kitchen, cookware, camping kit and optional extras to customize your booking." },
