        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              <strong>{t("Tarifas Furgocasa:")}</strong> {t("Precios desde")} {COMPANY.rentalPolicy.dailyRateFrom.lowSeason}{t("€/día")} {t("(temporada baja),")} {COMPANY.rentalPolicy.dailyRateFrom.midSeason}{t("€/día")} {t("(media),")} {COMPANY.rentalPolicy.dailyRateFrom.highSeason}{t("€/día")} {t("(alta).")} {t("Descuentos de hasta")} {COMPANY.rentalPolicy.durationDiscounts.oneWeek}, {COMPANY.rentalPolicy.durationDiscounts.twoWeeks} {t("y")} {COMPANY.rentalPolicy.durationDiscounts.threeWeeks} {t("en alquileres de 1, 2 o 3 semanas.")} {t("Incluido:")} {t("Kilómetros ilimitados")}, {t("seguro,")} {t("segundo conductor, kit cocina y camping.")} {t("Fianza:")} {COMPANY.depositAmount.toLocaleString("es-ES")}€. {t("Pago:")} {COMPANY.rentalPolicy.bookingPayment.reservationPercent}% {t("al reservar,")} {COMPANY.rentalPolicy.bookingPayment.reservationPercent}% {t("15 días antes.")} {t("Cancelación gratuita hasta")} {COMPANY.rentalPolicy.cancellation.freeUntilDaysBeforePickup} {t("días antes.")}
            </p>
          </div>
        </div>
      </section>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-furgocasa-blue text-white">
                    ...
                    <th className="py-6 px-6 text-center font-heading font-bold text-base border-r border-blue-800/30 bg-white/5">
                      {t("Menos de una semana")}
                    </th>
                    <th className="py-6 px-6 text-center font-heading font-bold text-base border-r border-blue-800/30 bg-white/10">
                      {t("Al menos una semana")}
                    </th>
                    <th className="py-6 px-6 text-center font-heading font-bold text-base border-r border-blue-800/30 bg-white/5">
                      {t("Al menos dos semanas")}
                    </th>
                    <th className="py-6 px-6 text-center font-heading font-bold text-base bg-white/10">
