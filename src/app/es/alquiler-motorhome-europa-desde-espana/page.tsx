...
const MOTORHOME_EUROPA_METADATA: Metadata = {
  ...
  twitter: {
    ...
    description: "Furgocasa: flota premium desde 95€/día con kilómetros ilimitados para recorrer toda Europa. Seguro europeo, asistencia 24/7 en español. Dreamer, Knaus, Weinsberg.",
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center">
        <div className="absolute inset-0 w-full h-full overflow-hidden">
          <Image
            ...
            alt="Furgocasa - Alquiler de motorhome en Europa"
            fill
            priority
            sizes="100vw"
        ...
        <div className="relative z-10 w-full text-center">
          <div className="w-full px-4 md:px-[25%] space-y-3">
            ...
            <p className="text-base md:text-lg text-white/90 font-light leading-relaxed max-w-3xl mx-auto tracking-wide mb-4" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.8)' }}>
              Dreamer, Knaus, Weinsberg. Alquiler desde España por toda Europa.
            </p>
          </div>
