 ...
 * SEO: alquiler motorhome españa, alquiler autocaravana españa
 */
...
const METADATA_BASE: Metadata = {
    ...
    images: [
      {
        ...
        width: 1920,
        height: 1080,
        alt: "Alquiler de motorhome y camper en España - Furgocasa",
        type: "image/webp",
      },
    ],
    locale: "es_ES",
  ...
  twitter: {
    ...
    site: "@furgocasa",
    creator: "@furgocasa",
    title: "Alquiler Motorhome España | Campers desde Murcia",
    description: "Motorhomes y campers en alquiler en España. Kilómetros ilimitados, equipamiento completo.",
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-6xl mx-auto space-y-3 pt-16 md:pt-0">
            ...
            <div className="flex items-center justify-center gap-1" style={{ marginBottom: "0.5rem" }}>
              {[1, 2, 3, 4, 5].map((star) => (
                <span key={star} className="text-yellow-400 text-3xl md:text-4xl">
                  ★
                </span>
              ))}
            </div>
            ...
            <p className="text-sm md:text-base lg:text-lg text-white/85 font-light leading-relaxed max-w-3xl mx-auto tracking-wide" style={{ textShadow: "1px 1px 4px rgba(0,0,0,0.8)" }}>
              {t("Las mejores furgonetas campers de gran volumen en alquiler")} en España
            </p>
          </div>
          ...
          <div className="text-center mb-8 lg:mb-12 max-w-5xl mx-auto">
            ...
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="text-base lg:text-lg text-gray-700 leading-relaxed">
                {t("Contamos con los mejores modelos de furgonetas campers del mercado.")} Alquiler en Murcia con entrega en toda España.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center max-w-3xl mx-auto bg-gray-50 p-6 lg:p-8 rounded-2xl shadow-sm border border-gray-100">
            <p className="text-lg lg:text-xl font-medium text-gray-700">
              {t("Descuentos de hasta el")}{" "}
              <span className="text-furgocasa-orange font-bold text-xl lg:text-2xl mx-1">-10%, -20% y -30%</span>{" "}
              {t("en alquileres de 1, 2 o 3 semanas")}.
            </p>
          </div>
