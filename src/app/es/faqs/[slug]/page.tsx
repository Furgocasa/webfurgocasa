...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      siteName: 'Furgocasa',
      images: [{ url: "https://uygxrqqtdebyzllvbuef.supabase.co/storage/v1/object/public/media/slides/DJI_0008-2.webp", width: 1200, height: 630, alt: "Furgocasa - FAQs" }],
    },
    robots: {
      index: true,
      follow: true
...
export default async function FaqDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const alternates = buildCanonicalAlternates(`/faqs/${slug}`, "es");
        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              ...
              <h2 className="text-xl font-bold text-gray-800 mb-4">Respuesta</h2>
