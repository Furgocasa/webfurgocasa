            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${conditionLabels[vehicle.condition].color}`}>
                ...
                <p className="text-gray-600 mb-6">{vehicle.short_description}</p>

                {/* Specs grid */}
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 py-6 border-y border-gray-100">
                  <div className="text-center">
                    <Gauge className="h-6 w-6 mx-auto text-gray-400 mb-2" />
                  ...
                  <div className="text-center">
                    <Fuel className="h-6 w-6 mx-auto text-gray-400 mb-2" />
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  {/* Habitabilidad */}
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Habitabilidad</h3>
                  ...
                  {/* Motor */}
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Motor y mecánica</h3>
                    <div className="space-y-2">
                      <div className="flex justify-between py-2 border-b border-gray-100">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6 sticky top-24">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <a
                    href={`https://wa.me/34968000000?text=Hola, me interesa el ${vehicle.name}`}
                    target="_blank"
              ...
              <div className="bg-white rounded-2xl shadow-sm p-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Calle Ejemplo, 123</p>
                    <p className="text-gray-600 text-sm">30001 Murcia</p>
                  </div>
                </div>
              </div>
            </div>
