  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 font-amiko pt-20">
        ...
        {/* Oferta Principal - Invierno Mágico 2026 - Modernizado */}
        ...
        {/* Por qué elegir Furgocasa - Modernizado */}
                ...
                {[
                  ...
                  <div key={index} className="flex flex-col items-center text-center p-4 z-10 group">
                    <div className="w-16 h-16 bg-white border-4 border-gray-100 group-hover:border-furgocasa-blue rounded-2xl flex items-center justify-center mb-6 shadow-lg transform group-hover:scale-110 transition-all duration-300">
                      <item.icon className="w-8 h-8 text-furgocasa-blue group-hover:text-furgocasa-orange transition-colors" />
                    </div>
                    <div className="bg-white px-4 py-2 rounded-xl shadow-sm border border-gray-100 min-h-[80px] flex items-center justify-center w-full">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-heading font-bold text-gray-900 mb-4">
                {t("¿Te interesa alguna de estas ofertas?")}
              </h2>
              <p className="text-xl text-gray-500">
                {t("Contáctanos sin compromiso")}
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 mb-16">
              ...
              <a
                ...
                className="group bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 hover:bg-white hover:shadow-xl transition-all duration-300 text-center"
              >
                <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Mail className="w-10 h-10 text-furgocasa-blue" />
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2 group-hover:text-furgocasa-blue transition-colors">
                  {t("Enviar email")}
                </h3>
                <p className="text-lg text-gray-600">info@furgocasa.com</p>
              </a>
              ...
              >
                ...
                <p className="text-lg text-gray-600">+34 673 41 40 53</p>
              </a>
            </div>

            {/* Horarios */}
            <div className="max-w-4xl mx-auto bg-furgocasa-blue/5 rounded-[2.5rem] p-10 md:p-14">
              <div className="flex items-center justify-center gap-3 mb-10">
                <Clock className="w-8 h-8 text-furgocasa-blue" />
              ...
              <div className="grid md:grid-cols-2 gap-10 md:gap-16">
                <div className="text-center md:text-left">
                  <h4 className="font-bold text-lg text-gray-900 mb-4 flex items-center justify-center md:justify-start gap-2">
                    <span className="w-2 h-2 rounded-full bg-furgocasa-orange"></span>
                    {t("Atención al público")}
                  </h4>
                  <div className="space-y-2 text-gray-600 bg-white p-6 rounded-2xl shadow-sm">
                    <p className="font-bold text-gray-900">{t("Lunes a Viernes")}</p>
                    <p>10:00 - 14:00 | 17:00 - 19:30</p>
                  </div>
                </div>
                ...
                <div className="text-center md:text-left">
                  <h4 className="font-bold text-lg text-gray-900 mb-4 flex items-center justify-center md:justify-start gap-2">
                    <span className="w-2 h-2 rounded-full bg-furgocasa-orange"></span>
                    {t("Entrega y recogida")}
                  </h4>
                  <div className="space-y-4 text-gray-600 bg-white p-6 rounded-2xl shadow-sm">
                    <div>
                      <p className="font-bold text-gray-900">{t("Lunes a Sábado")}</p>
                      <p>10:00 - 19:00</p>
                    </div>
                    <div className="pt-2 border-t border-gray-100">
                      <p className="font-bold text-gray-900">{t("Domingos")}</p>
                      <p>18:00 - 19:00</p>
                    </div>
                  </div>
                </div>
              ...
              <p className="text-xs text-gray-400 mt-10 text-center pt-6 max-w-2xl mx-auto">
                {t("Al utilizar cualquier de estas formas de contacto reconozco aceptar los Términos y Condiciones y la Política de Privacidad.")}
              </p>
            </div>
          </div>
        </section>
