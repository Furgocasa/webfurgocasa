        ...
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-8">
              <LocalizedLink href="/reservar" className="inline-flex items-center gap-2 bg-furgocasa-orange text-white font-semibold py-3 px-8 rounded-lg hover:bg-furgocasa-orange-dark transition-colors">
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-6">
              <LocalizedLink href="/faqs" className="text-furgocasa-orange hover:underline">Ver todas las FAQs →</LocalizedLink>
            </div>
          </div>
        </section>
