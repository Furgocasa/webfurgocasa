    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Calendar */}
          <div className="absolute top-full left-0 right-0 md:left-0 md:right-auto mt-2 z-[9999] bg-white rounded-xl shadow-xl border border-gray-200 p-2 md:p-4 w-full md:w-auto">
