...
export function AdminHeader({ admin, onMenuClick }: AdminHeaderProps) {
  ...
  // ✅ OPTIMIZADO: Usar el logout del contexto (no hace llamadas adicionales)
  ...
  return (
    <header className="bg-white border-b border-gray-200 px-4 py-3 lg:py-4">
      <div className="flex items-center justify-between gap-3 lg:gap-4">
        ...
        {/* Right side - Compacto en mobile/tablet */}
        <div className="flex items-center gap-2 lg:gap-4">
          {/* View website - Ocultar texto en mobile/tablet */}
          <a
            href="/"
            target="_blank"
          ...
          {/* User menu - Compacto en mobile/tablet */}
          <div className="relative">
            <button
