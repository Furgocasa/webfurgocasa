...
-- VERSIÓN SEGURA (elimina vistas antes de recrear)
-- ============================================

-- ============================================
-- 0. LIMPIAR VISTAS EXISTENTES (si existen)
-- ============================================
...
-- ============================================
-- 4. RECREAR VISTAS PARA ANÁLISIS
-- ============================================
...
DROP POLICY IF EXISTS "Administradores pueden leer todas las búsquedas" ON public.search_queries;
DROP POLICY IF EXISTS "API puede insertar búsquedas" ON public.search_queries;
DROP POLICY IF EXISTS "API puede actualizar búsquedas" ON public.search_queries;
DROP POLICY IF EXISTS "Solo administradores pueden eliminar búsquedas" ON public.search_queries;
...
SELECT '✅ Sistema instalado correctamente' as status;
SELECT COUNT(*) || ' índices creados' as indices FROM pg_indexes WHERE tablename = 'search_queries';
